...
for i = 1:loops
        ...
        filename         = ['C:\Data\1550TES\DR TESs III Squid3respliced' '_' num2str(ts,'%d') '.daq'];	% auto filename
...
%         [test] = Alazar('initialize_and_run',S,ch,T,filename,P,'show','nopopup','analyze','histogram'); % for photon histogram
