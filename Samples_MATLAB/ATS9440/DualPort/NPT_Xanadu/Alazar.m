function [varargout,data] = Alazar(S,varargin)
%
...
% S.numBuffers            = 2;
% S.RecordsPerBuffer      = 20;
% S.numchannels2record    =2;
% S.buffersPerAcquisition =1;
...
if ~configureBoard(boardHandle,S)
  fprintf('Error: Board configuration failed\n');
  return
end

Op=varargin;
[result,data] = acquireData(boardHandle,S,filename,Op);
...
if sum(strcmp(varargin,'calibrate')),
